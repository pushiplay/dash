...
Only requiring some minor changes is pushi.cpp.
...
Changes to pushi.cpp
----------------------
pushi.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
