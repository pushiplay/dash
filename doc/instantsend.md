...
This mechanism has been integrated into Bitcore-Node-Pushi which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/pushiplay/insight-api-pushi#web-socket-api](https://github.com/pushiplay/insight-api-pushi#web-socket-api)
* API: [https://github.com/pushiplay/insight-api-pushi#instantsend-transactions](https://github.com/pushiplay/insight-api-pushi#instantsend-transactions)
...
By default, the Pushi Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pushi Core daemon:
