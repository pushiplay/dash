...
Pushi Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9847.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9846 for connections and services them.
...
However, in open source software such as Pushi Core, where everyone uses
...
pay attention to for reviewers of Pushi Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Pushi Core uses tinyformat, which is type safe. Leave them out to avoid confusion
