...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Pushi related functionality
...
/*
    ...
    allow endless transaction that would bloat Pushi and make it unusable. To
