 ...
 *
 *   // network
 *   CPushiNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.pushi.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CPushiNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: PushiNetwork
// //   -- signature requirements : Key1(User)
// class CPushiNetworkVariable : public CGovernanceObject
// {
// private:
