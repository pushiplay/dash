...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PushiNetwork") type = PushiNetwork;
    if(strType == "PushiNetworkVariable") type = PushiNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PushiNetwork) s = "PushiNetwork";
    if(type == PushiNetworkVariable) s = "PushiNetworkVariable";
