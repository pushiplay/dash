...
#define BOOST_TEST_MODULE Pushi Test Suite

#include "test_pushi.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_pushi_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
