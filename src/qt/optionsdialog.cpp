    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PUSHI-light"), QVariant("light"));
    ui->theme->addItem(QString("PUSHI-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("PUSHI-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("PUSHI-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PUSHI-traditional"), QVariant("trad"));
