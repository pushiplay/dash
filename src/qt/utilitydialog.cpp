    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Pushi Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Pushi Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  pushi-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Pushi in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PUSHI, 0.1 PUSHI, 1 PUSHI and 10 PUSHI -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://pushiplay.atlassian.net/wiki/display/DOC/PrivateSend\">https://pushiplay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Pushi Core is shutting down...") + "<br /><br />" +
