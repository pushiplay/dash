    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Pushi Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pushi address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pushi: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Pushi Core"), this);
    aboutAction->setStatusTip(tr("Show information about Pushi Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pushi Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pushi addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pushi addresses"));
    ...
    openAction->setStatusTip(tr("Open a pushi: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pushi Core help message to get a list with possible Pushi Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Pushi Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pushi network", "", count));
    } else {
...
{
    QString strTitle = tr("Pushi Core"); // default title
